...
const messages = defineMessages({
  ...
  jellyfinSettings: 'GBstreams Settings',
  jellyfinSettingsDescription:
    'Optionally configure the internal and external endpoints for your GBstreams server. In most cases, the external URL is different to the internal URL. A custom password reset URL can also be set for GBstreams login, in case you would like to redirect to a different password reset page.',
